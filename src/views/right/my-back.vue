      ...
      <div class="my-bottom-container">
        ...
        <div class="social-container">
          ...
          <div class="social-item">
            <a href="https://blog.csdn.net/qq_39848608" target="_blank">
              <img src="@/assets/icons/csdn.png" class="social-icon">
            </a>
            <a href="http://wpa.qq.com/msgrd?v=3&uin=2282816304&site=qq&menu=yes" target="_blank">
              <img src="@/assets/icons/qq.png" class="social-icon">
            </a>
            <a href="https://github.com/lza0807" target="_blank">
        ...
        <a-divider />
        <div class="social-container">
          <div class="social-text">刘子安求带走</div>
          <div class="join-item">
            <a href="http://wpa.qq.com/msgrd?v=3&uin=2282816304&site=qq&menu=yes">
              <img src="@/assets/icons/qq.png" class="social-icon">
            </a>
          </div>
        </div>
